...
|---|---|
|¿Cuántos días tengo para solicitar un reembolso? | Según la información proporcionada, no se especifica un plazo exacto para solicitar un reembolso en todos los casos. Sin embargo, en el Ejemplo 2 se menciona que un cliente puede solicitar una devolución por retracto dentro de los 10 días corridos después de recibir el producto, siempre que esté sin uso.Por lo tanto, para casos de retracto (devolución por cambio de opinión), el plazo es de 10 días corridos. Para otros casos, como daños o productos incorrectos, se recomienda presentar evidencia lo antes posible, como en el Ejemplo 1, donde se menciona un plazo de 48 horas para presentar evidencia fotográfica. |
